...
ActiveRecord::Schema.define(:version => 20111105052819) do
  ...
  add_index "batches", ["is_deleted", "is_active"], :name => "index_batches_on_is_deleted_and_is_active", :limit => {"is_active"=>nil, "is_deleted"=>nil}
  ...
  add_index "timetable_entries", ["weekday_id", "batch_id", "class_timing_id"], :name => "by_timetable", :limit => {"class_timing_id"=>nil, "weekday_id"=>nil, "batch_id"=>nil}
